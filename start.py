...
import os
from func import url_binance, data_time_ekb
...
async def echo_message(message: types.Message):
    if message.text == "Текущее время и дата":
        await bot.send_message(message.from_user.id, get_time(data_time_ekb))
        ...
        await bot.send_message(message.from_user.id, pars_bus(data_time_ekb))
